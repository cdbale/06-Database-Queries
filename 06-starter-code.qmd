...
```{r}
# install the 'qualtRics' package using the console, and load the package here
...
# This code displays all the available surveys within the Qualtrics API
...
Fetch the "Hammocks and Life" survey and write it to your local hard drive. Hint: the survey ID is `SV_73xYIxZuxsqAx6Z`.
...
#### Note: the code in this section will not work, it is here for example purposes only.

```{r}
# these packages would be used to access a SQL database
